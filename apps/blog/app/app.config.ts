const hero = {
   title: 'Vista a infância com leveza, cor e amor',
   headline: 'A escolha para quem busca moda de luxo infantil.',
}
...
const faqItems = [
   ...
   {
      content:
         'Não. Vendemos uma ampla linha de marcas e modelos de moda infantil. Melissa, Cia da Meia, Baby Gut, etc.',
      label: 'Vende apenas produtos Petit Cherie?',
   },
]
...
const newsletter = {
   ...
   perks: [
      'Lançamentos Petit Cherie',
      'Curadoria de looks por idade',
